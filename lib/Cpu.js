...
define([], function() {
  ...
  Cpu.prototype.updatePc = function() {
  ...
  Cpu.prototype.step = function() {
    var instruction, opcode, nbopcode,
        target, source;
    ...
    if (opcode === this.opcodes['NONBASIC']) {
      nbopcode = (instruction >> 4) & parseInt('111111', 2);
      ...
      switch (nbopcode) {
        case this.nbopcodes['JSR']:
          ...
          if (source > 31) {
            ...
            this.memory.write(this.registers[0x1b], this.registers[0x1c] + 2);
          } else {
            // Next word is the next instruction
            this.memory.write(this.registers[0x1b], this.registers[0x1c] + 1);
          }
          this.registers[0x1c] = source.value;
      }
      this.callbacks.step();
      return;
    }
    ...
    switch(opcode) {
      ...
      case this.opcodes['DIV']:
        if (source.value === 0) {
          ...
          this.registers[0x1d] = ((Math.floor((target.value << 16) / source.value)) & 0xffff);
        }
        this.updatePc();
        break;
